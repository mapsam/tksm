  ...
  return (
    <Content
      ...
      <Block id="FAQ">
        ...
        <p>We do, kinda. In lieu of <em>stuff</em>, our <a href="/registry">registry</a> includes a few "funds" that you can contribute to, if you desire. We're not using a third-party registry service because they take a percentage of <em>your</em> money and that doesn't sit well with us.</p>

        <h2>Are kids allowed to the wedding?</h2>
        <p>Nope!</p>

        <h2>Are kids allowed to the other events?</h2>
        <p>Kids are allowed to the Friday and Sunday events!</p>
        ...
        <h2>Heat? Smoke?</h2>
        <p>You thought our biggest problem in Seattle was rain, didn't you? The venue is indoors and air conditioned if it's too sweaty outside. Otherwise we'll keep the doors and garage door open so we can enjoy the summer evening.</p>
