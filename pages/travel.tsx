...
export default function Page() {
  return (
    <div className="content">
      ...
      <Block id="AIRPORT" style={{ backgroundColor: '#F2F0F2' }}>
        <h1>Airport</h1>
      ...
      <Block id="PUBLIC-TRANSPORTATION" style={{ backgroundColor: '#F2F0F2' }}>
      ...
      <Block id="RIDESHARE" style={{ backgroundColor: '#F2F0F2' }}>
        <h1>Rideshare</h1>
